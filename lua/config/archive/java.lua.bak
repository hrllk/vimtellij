...
--     '-jar', vim.fn.expand('$HOME') .. '/.local/share/nvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_1.7.0.v20250331-1702.jar',
--     '-configuration', vim.fn.expand('$HOME') .. '/.local/share/nvim/mason/packages/jdtls/config',
