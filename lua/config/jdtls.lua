local function get_jdtls()
    ...
    local launcher = vim.fn.glob(jdtls_path .. "/plugins/org.eclipse.equinox.launcher_*mac*aar*.jar")
    vim.notify("JDTLS Launcher Path: " .. launcher, vim.log.levels.INFO)
...
local function setup_jdtls()
    vim.notify("Attempting to set up JDTLS", vim.log.levels.INFO)
