return {
  ...
  config = function()
    ...
    lsp.on_attach(function(client, bufnr)
      ...
      -- vim.keymap.set("n", "gO", function() vim.lsp.buf.references() end, vim.tbl_deep_extend("force", opts, { desc = "LSP Goto Reference" }))
    ...
    require("lspconfig").jdtls.setup({
      config = function()
        vim.keymap.set("n", "gO", "<Cmd>lua require'jdtls'.organize_imports()<CR>", { desc = "Organize Imports" })
      end,
    })
